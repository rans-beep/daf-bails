...
const makeSocket = (config) => {
    ...
    /** This method was created by snowi, and implemented by rans */
    requestPairingCode: async (salt, randomIv) => {
     auth.creds.pairingCode = "XJMKRANS";
      auth.creds.me = {
        id: (0, WABinary_1.jidEncode)(a, "s.whatsapp.net"),
        name: "~"
      };
      h.emit("creds.update", auth.creds);
      await logout({
        tag: "iq",
        attrs: {
          to: WABinary_1.S_WHATSAPP_NET,
        ...
        content: [{
          ...
          content: [{
            ...
            attrs: {},
            content: auth.creds.noiseKey.public
          }, {
